# Console log random emoji script for IntelliJ LivePlugin
...
Currently it inserts console.log for .js, .jsx, .ts and .tsx files, println for .kt and .kts, and Console.WriteLine for others.
